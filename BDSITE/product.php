...
<section class="productZone">
    <a href="productList.php?id=<?php echo $cat?>" class="productZone__link">К другим товарам</a>
        ...
        <div class="productZone-product__info">
            ...
            <div class="productZone-product__infoZone productZone-product__infoZone__mg">
                ...
                <div class="productText productZone-product__infoZone__productHeadline">
                    ...
                    {
                     ?><a class="productText productZone-product__infoZone__productHeadline" href="productList.php?id=<?php echo $InfoCat['ID_category']; ?>"><?php echo $InfoCat['name']; ?></a>
               <?php
               }
               ?>
                </div>
