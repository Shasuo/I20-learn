...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 25 2022 г., 17:20
...
START TRANSACTION;
SET time_zone = "+00:00";
create database IF NOT exists `bd_product` default character SET utf8mb4 collate utf8mb4_unicode_ci;
USE `bd_product`;
...
INSERT INTO `products` (`ID_product`, `name`, `description`, `main_IMG`, `price`, `price_discount`, `price_promo`, `category`, `amount`, `prductActive`) VALUES
(453, 'Швабра (удлиненная)', 'Длинная швабра, хорошо подходит для мытья полов в труднодоступных пространствах', 4, 300, 200, 200, 1, 987, 1),
(2345, 'Ведро (увеличенной емкости)', 'Ведро большой емкости для мытья полов', 3, 300, 280, 280, 1, 78, 1),
(2672, 'ps3', 'Консоль игровая ps3', 1, NULL, NULL, NULL, 2, 56, 1),
(3847, 'Диван (подержанный)', 'Длинный диван для всей семьи (бывший в эксплуатации)', 5, 324432, 32432, 2345, 3, 56, 1),
(4356, 'Play Station 4', 'Игровая консоль нового поколения play station 4', 2, 25000, 22000, 19000, 2, 40, 1),
(4536, 'Ведро (уменьшенной емкости)', 'Ведро для небольших объемов воды', 3, 100, 80, 80, 1, 570, 1),
(6790, 'Play staion 3 (м)', 'Игровая консоль play station 3 с уменьшенным объемом памяти', 1, 1000, 400, 600, 2, 40, 1),
(7637, 'Кресло (красное)', 'Красное кресло', NULL, 213234, 4342, 52234, 3, 56, 1),
(7653, 'Play station 3', 'Увеличенный объем памяти', 1, 6000, 5678, 3005, 2, 40, 1),
(8475, 'Стол (кофейный)', 'Кофейный стол кофейного оттенка', 6, 213321, 321321, 32133, 3, 78, 1),
(9874, 'Ведро', 'Объемное ведро для мытья полов', 3, 213, 199, 190, 1, 78, 1),
(43567, 'Диван', 'Длинный и удобный диван для всей семьи', 5, 30000, 234324, 2345, 3, 56, 1);
